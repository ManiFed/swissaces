        ...
        <div className="relative z-10">
          <div className="flex items-center gap-3 mb-2">
            <div className="w-10 h-10 bg-primary-foreground/20 rounded-lg flex items-center justify-center">
              <span className="text-primary-foreground font-bold text-2xl font-serif">♠</span>
            </div>
            <span className="text-2xl font-serif text-primary-foreground font-bold">Swiss Aces</span>
          </div>
        </div>
        <div className="relative z-10">
          <h2 className="text-4xl xl:text-5xl font-serif font-bold text-primary-foreground leading-tight mb-4">
            The beloved Swiss card game, now online.
          </h2>
          <p className="text-primary-foreground/70 text-lg max-w-md">
            Challenge friends, beat smart bots, and climb the leaderboard.
          </p>
        </div>
        <div className="relative z-10 text-primary-foreground/40 text-sm">
          © 2026 Swiss Aces
        </div>
      </div>
        ...
        >
          ...
          <div className="lg:hidden text-center mb-8">
            <div className="flex items-center justify-center gap-3 mb-2">
              ...
              <h1 className="text-3xl font-serif text-foreground font-bold">Swiss Aces</h1>
            </div>
            <p className="text-muted-foreground text-sm">The classic card game, online</p>
          </div>
          ...
          <Card className="border-border shadow-xl">
            ...
            <CardContent>
              ...
              <Button variant="outline" className="w-full h-11" onClick={handleGoogleSignIn} disabled={isSubmitting}>
